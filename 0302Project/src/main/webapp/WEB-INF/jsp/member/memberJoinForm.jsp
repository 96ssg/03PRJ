		...
		<form id="frm" name="frm" action="memberJoin.do" method="post">
			<div>
				<table border="1">
					<tr>
						<th width="150">아이디</th>
						<td width="300"><input type="text" id="uId" name="uId">&nbsp;
					...
					<tr>
						<th width="150">이름</th>
						<td width="300"><input type="text" id="uName" name="uName"></td>
					</tr>
					<tr>
					...
					<tr>
						<th width="150">주소</th>
						<td width="300"><input type="text" id="uAddress" name="uAddress"></td>
					</tr>
					<tr>
						<th width="150">생년월일</th>
						<td width="300"><input type="text" id="uBirth" name="uBirth"></td>
					</tr>
				</table>
			</div><br />
			<div>
